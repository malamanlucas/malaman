...
<input type="hidden" id="url_deletar" value="<c:url value="/item/deletar" />" />
<input type="hidden" id="url_page" value="item/gerenciar/paginate" />
<input type="hidden" id="total" value="${total}" />
<input type="hidden" id="message_delete" value="Ingrediente excluido com sucesso" />
	...
	<div id="wrapper-gerenciar">
		...
		<sec:authorize access="hasRole('ROLE_GESTOR')">
			<div class="txt31" id="cadastro-item">
				<a class="submit-form" url="<c:url value="/item/" />" >Cadastrar</a>
			</div>
		</sec:authorize>

		<div class="txt31 caixa" id="txt-qtd-itens"><span id="totais">?</span> Ingrediente(s) cadastrado(s)</div>
